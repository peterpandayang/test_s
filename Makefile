PROGS = testit
OBJS = add.o ifelse.o sum_array_s.o find_max_s.o add
CFLAGS = -g
...
testit : testit.c add.o ifelse.o sum_array_s.o find_max_s.o
	gcc -o testit testit.c add.o ifelse.o sum_array_s.o find_max_s.o
