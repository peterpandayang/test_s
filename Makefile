PROGS = testit
OBJS = sum_array_s.o find_max_s.o fibo_rec_s.o find_sub_in_s_s.o fibo_iter_s.o add
CFLAGS = -g
...
testit : testit.c sum_array_s.o find_max_s.o fibo_rec_s.o find_sub_in_s_s.o fibo_iter_s.o
	gcc -o testit testit.c sum_array_s.o find_max_s.o fibo_rec_s.o find_sub_in_s_s.o fibo_iter_s.o
